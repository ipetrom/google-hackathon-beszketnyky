...
export default function DamageReport({
  ...
  // Group move-out photos by room_type, deduplicate by id, keep only latest per room
      ...
      {rooms.map((room, roomIdx) => {
        ...
        return (
          ...
          >
            ...
            {/* Move-out photos */}
            {!photosLoading && roomPhotoGroup.moveOut.length > 0 && (
              <div className="border-b border-gray-100 px-4 py-3 dark:border-gray-800">
                ...
                <div className="flex gap-2 overflow-x-auto pb-1">
                  {roomPhotoGroup.moveOut.map((photo) => (
                    <button
                      ...
                      className="flex-shrink-0 cursor-pointer overflow-hidden rounded-lg transition-opacity hover:opacity-80"
                    >
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
